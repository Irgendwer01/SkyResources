...
public class ModItems
{
	...
	{
		ModItems.addGem("emerald", 0xFF12DB3A, 0.015F, new ItemStack(Blocks.STONE));
		ModItems.addGem("diamond", 0xFF6BFFFD, 0.033F, new ItemStack(Blocks.STONE));
		ModItems.addGem("ruby", 0xFFFA1E1E, 0.015F, new ItemStack(Blocks.STONE));
		ModItems.addGem("sapphire", 0xFF1E46FA, 0.015F, new ItemStack(Blocks.STONE));
		ModItems.addGem("peridot", 0xFF1CB800, 0.015F, new ItemStack(Blocks.STONE));
		ModItems.addGem("redGarnet", 0xFFC90014, 0.015F, new ItemStack(Blocks.STONE));
		ModItems.addGem("yellowGarnet", 0xFFF7FF0F, 0.015F, new ItemStack(Blocks.STONE));
		ModItems.addGem("apatite", 0xFF2B95FF, 0.600F, new ItemStack(Blocks.STONE));
		ModItems.addGem("amber", 0xFFF5CC53, 0.021F, new ItemStack(Blocks.STONE));
		ModItems.addGem("lepidolite", 0xFF57008A, 0.021F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("malachite", 0xFF23AD00, 0.021F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("onyx", 0xFF3D3D3D, 0.021F, new ItemStack(Blocks.STONE));
		ModItems.addGem("moldavite", 0xFFADFF99, 0.021F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("agate", 0xFFFF63FF, 0.021F, new ItemStack(Blocks.STONE));
		ModItems.addGem("opal", 0xFFDEDEDE, 0.021F, new ItemStack(Blocks.STONE));
		ModItems.addGem("amethyst", 0xFF780078, 0.018F, new ItemStack(Blocks.STONE));
		ModItems.addGem("jasper", 0xFF874800, 0.018F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("aquamarine", 0xFF36E7FF, 0.018F, new ItemStack(Blocks.STONE));
		ModItems.addGem("heliodor", 0xFFFFFF7D, 0.018F, new ItemStack(Blocks.STONE));
		ModItems.addGem("turquoise", 0xFF2EF2C8, 0.018F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("moonstone", 0xFF016A8A, 0.018F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("morganite", 0xFFFA61FF, 0.018F, new ItemStack(Blocks.STONE));
		ModItems.addGem("carnelian", 0xFF630606, 0.018F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("beryl", 0xFF46E334, 0.015F, new ItemStack(Blocks.STONE));
		ModItems.addGem("goldenBeryl", 0xFFD6AE2B, 0.015F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("citrine", 0xFF871616, 0.015F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("indicolite", 0xFF39E6BD, 0.015F, new ItemStack(Blocks.STONE));
		ModItems.addGem("garnet", 0xFFFF9999, 0.015F, new ItemStack(Blocks.STONE));
		ModItems.addGem("topaz", 0xFFFFD399, 0.015F, new ItemStack(Blocks.STONE));
		ModItems.addGem("ametrine", 0xFFA300BF, 0.015F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("tanzanite", 0xFF00076E, 0.015F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("violetSapphire", 0xFF451287, 0.012F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("alexandrite", 0xFFE3E3E3, 0.012F, new ItemStack(Blocks.NETHERRACK));
		ModItems.addGem("blueTopaz", 0xFF1000C4, 0.012F, new ItemStack(Blocks.NETHERRACK));
		...
		ModItems.addGem("lapis", 0xFF075BBA, 0.54F, new ItemStack(Blocks.STONE));
		ModItems.addGem("quartzBlack", 0xFF171717, 0.36F, new ItemStack(Blocks.STONE));
		ModItems.addGem("certus", 0xFFB0F4F7, 0.48F, new ItemStack(Blocks.STONE), "crystalCertusQuartz");
